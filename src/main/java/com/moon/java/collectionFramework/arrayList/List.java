...
public interface List<E> {
    ...
    *  @return 리스트에서 중복을 허영하지 않을 경우에 리스트에 이미 중복되는 요소가 있을경우 
    *          {@code false}를 반환하고, 중복되는 원소가 없을 경우 {@code true}를 반환
    * */
    boolean add(E value);
    ...
    * */
    ...
    /*
    * 리스트에서 특정 요소를 삭제한다.
    * 동일한 요소가 여러 개일 경우 가장 처음 발견한 요소만 삭제한다.
    *
    ...
    * @return 리스트에 요소가 없을 경우 {@code ture}, 요소가 있을 경우 {@code false}를 반환
    *
    * */
    boolean isEmpty();
